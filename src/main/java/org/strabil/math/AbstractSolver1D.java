...
abstract public class AbstractSolver1D<F extends Ops.DoubleOp> {
    ...
    public double solve(final F f, double accuracy, final double guess, final double step) {
        ...
        DoTest.require(accuracy > 0.0 , "accuracy must be positive"); // QA:[RG]::verified // TODO: message
        ...
        // TODO: code review :: please verify against DoTest/C++ code
    ...
    public double solve(final F f, double accuracy, final double guess, final double xMin, final double xMax) {
        ...
        DoTest.require(accuracy > 0.0 , "accuracy must be positive"); // QA:[RG]::verified // TODO: message
        DoTest.require(xMin < xMax , "invalid range: xMin >= xMax"); // QA:[RG]::verified // TODO: message
        DoTest.require(!lowerBoundEnforced || xMin >= lowerBound , "xMin < enforced low bound"); // QA:[RG]::verified // TODO: message
        DoTest.require(!upperBoundEnforced || xMax <= upperBound , "xMax > enforced hi bound"); // QA:[RG]::verified // TODO: message
        ...
        // TODO: code review :: please verify against DoTest/C++ code
        DoTest.require(fxMin * fxMax < 0.0 , "root not bracketed"); // QA:[RG]::verified // TODO: message
        DoTest.require(guess > this.xMin , "guess must be greather than xMin"); // QA:[RG]::verified // TODO: message
        DoTest.require(guess < this.xMax , "guess must be lesser than xMax"); // QA:[RG]::verified // TODO: message
