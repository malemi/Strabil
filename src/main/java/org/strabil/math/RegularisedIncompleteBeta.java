...
public class RegularisedIncompleteBeta {
    ...
    public double evaluate(final double x,final double a, final double b) {
        ...
        DoTest.require(a > 0.0 , "a must be greater than zero"); // QA:[RG]::verified // TODO: message
        DoTest.require(b > 0.0 , "b must be greater than zero"); // QA:[RG]::verified // TODO: message
        ...
        DoTest.require(x>0.0 && x<1.0 , "x must be in [0,1]"); // QA:[RG]::verified // TODO: message
    ...
    private void checkMaxIterations(final int maxIterations){
    	DoTest.require(maxIterations>0 , "Expected maxIterations must be greater 0"); // QA:[RG]::verified // TODO: message
    }
