...
public class ErrorFunction implements Ops.DoubleOp {
    ...
    private final static double pp1  = -3.25042107247001499370e-01; /* 0xBFD4CD7D, 0x691CB913 */
    private final static double pp2  = -2.84817495755985104766e-02; /* 0xBF9D2A51, 0xDBD7194F */
    private final static double pp3  = -5.77027029648944159157e-03; /* 0xBF77A291, 0x236668E4 */
    private final static double pp4  = -2.37630166566501626084e-05; /* 0xBEF8EAD6, 0x120016AC */
    private final static double qq1  =  3.97917223959155352819e-01; /* 0x3FD97779, 0xCDDADC09 */
    private final static double qq2  =  6.50222499887672944485e-02; /* 0x3FB0A54C, 0x5536CEBA */
    ...
    private final static double pa3  =  3.18346619901161753674e-01; /* 0x3FD45FCA, 0x805120E4 */
    private final static double pa4  = -1.10894694282396677476e-01; /* 0xBFBC6398, 0x3D3E28EC */
    private final static double pa5  =  3.54783043256182359371e-02; /* 0x3FA22A36, 0x599795EB */
    private final static double pa6  = -2.16637559486879084300e-03; /* 0xBF61BF38, 0x0A96073F */
    private final static double qa1  =  1.06420880400844228286e-01; /* 0x3FBB3E66, 0x18EEE323 */
    private final static double qa2  =  5.40397917702171048937e-01; /* 0x3FE14AF0, 0x92EB6F33 */
    private final static double qa3  =  7.18286544141962662868e-02; /* 0x3FB2635C, 0xD99FE9A7 */
    ...
    private final static double ra3  = -6.23753324503260060396e+01; /* 0xC04F300A, 0xE4CBA38D */
    private final static double ra4  = -1.62396669462573470355e+02; /* 0xC0644CB1, 0x84282266 */
    private final static double ra5  = -1.84605092906711035994e+02; /* 0xC067135C, 0xEBCCABB2 */
    private final static double ra6  = -8.12874355063065934246e+01; /* 0xC0545265, 0x57E4D2F2 */
    private final static double ra7  = -9.81432934416914548592e+00; /* 0xC023A0EF, 0xC69AC25C */
    private final static double sa1  =  1.96512716674392571292e+01; /* 0x4033A6B9, 0xBD707687 */
    private final static double sa2  =  1.37657754143519042600e+02; /* 0x4061350C, 0x526AE721 */
    private final static double sa3  =  4.34565877475229228821e+02; /* 0x407B290D, 0xD58A1A71 */
    private final static double sa4  =  6.45387271733267880336e+02; /* 0x40842B19, 0x21EC2868 */
    private final static double sa5  =  4.29008140027567833386e+02; /* 0x407AD021, 0x57700314 */
    ...
    private final static double rb3  = -1.60636384855821916062e+02; /* 0xC064145D, 0x43C5ED98 */
    private final static double rb4  = -6.37566443368389627722e+02; /* 0xC083EC88, 0x1375F228 */
    private final static double rb5  = -1.02509513161107724954e+03; /* 0xC0900461, 0x6A2E5992 */
    private final static double rb6  = -4.83519191608651397019e+02; /* 0xC07E384E, 0x9BDC383F */
    private final static double sb1  =  3.03380607434824582924e+01; /* 0x403E568B, 0x261D5190 */
    private final static double sb2  =  3.25792512996573918826e+02; /* 0x40745CAE, 0x221B9F0A */
    private final static double sb3  =  1.53672958608443695994e+03; /* 0x409802EB, 0x189D5118 */
    private final static double sb4  =  3.19985821950859553908e+03; /* 0x40A8FFB7, 0x688C246A */
    private final static double sb5  =  2.55305040643316442583e+03; /* 0x40A3F219, 0xCEDF3BE6 */
    private final static double sb6  =  4.74528541206955367215e+02; /* 0x407DA874, 0xE79FE763 */
